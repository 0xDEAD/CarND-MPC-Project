...
// column of the row is the "timestep" (column0=current state)
// the last two rows are for the actuators
size_t x_start = 0;
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // state values need to be contrained to the value itself
  ...
  // return the first actuator values + trajectory-coordinates
